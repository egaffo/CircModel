...
plot_base_method_type_tiles <-
  ...
  #                    position = "top") +
  labs(x = NULL, y = NULL) +
  scale_fill_manual(values = setNames(tableau_color_pal(palette = "Nuriel Stone")(2),
...
fdr_dists <- dist(t(fdr_mat - 0.05), method = "canberra")

fdr_dists[is.na(fdr_dists)] <- max(fdr_dists, na.rm = T)
...
```{r, fig.width=6.692, fig.height=5}
