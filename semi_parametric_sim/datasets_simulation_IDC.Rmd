...
params:
  outdir: "IDC_sims"
  input_dataset_bjr_file: "../data/IDC_unfiltered_CirComPara2_circbjr.csv"
  input_dataset_meta_file: "../data/IDC_meta.csv"
---

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)

# params <- list(input_dataset_bjr_file = "../data/IDC_unfiltered_CirComPara2_circbjr.csv", 
#                input_dataset_meta_file = "../data/IDC_meta.csv", 
#                outdir = "IDC_sims")
...
sample_subset <- sample_libsize_clust_dt[!LibGroup %in% c(), Sample]
