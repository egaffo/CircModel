...
wrap_plots(rank_dendro +
               ...
               theme_dendro() +
               theme(axis.text.y = element_text(color = method_colors[label(rank_dendro_ddata)$label],
                                              angle = 0,
                                              hjust = 1),
...
wrap_plots(rank_dendro_n05 +
               ...
               coord_flip(xlim = c(.5, 38.5)) +
               theme_dendro() +
               theme(axis.text.y = element_text(color = method_colors[label(rank_dendro_ddata_n05)$label],
                                              angle = 0,
                                              hjust = 1),
                   # axis.text.y = element_blank(),
                   axis.text.x = element_blank(),
