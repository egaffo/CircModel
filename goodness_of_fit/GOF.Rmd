...
## import data
if(!file.exists("/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/TALLData_list.RData")){
  ...
  save(TALLData_list, file = "/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/TALLData_list.RData")
} else load("/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/TALLData_list.RData")
...
TData_df0 = read.csv(file = "/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/TALL/TData_df0.csv")
TALLdf0 = read.csv(file = "/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/TALL/AIC_df0.csv")
...
TData_df3 = read.csv(file = "/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/TALL/TData_df3.csv")
TALLdf3 = read.csv(file = "/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/TALL/AIC_df3.csv")
```
...
## import data
if(!file.exists("/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/DM1Data_list.RData")){
  ...
  V9newCols <- c("gene_id", "transcript_id")
  ## load circRNA data
  circrnas.gtf <- fread("/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/realdata/DM1/analyses/circular_expression/circRNA_collection/circrnas.gtf", colClasses = colClasses)
  ...
  count.data.file <- "/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/realdata/DM1/analyses/circular_expression/circRNA_collection/ccp_counts/bks.counts.union.intersected.csv"
  count.data <- fread(count.data.file)
  ...
  save(DM1Data_list, file = "/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/DM1Data_list.RData")
} else load("/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/DM1Data_list.RData")
...
meta_file_dm1 <- file.path(basedir.dm1, "analyses/meta_DM1.csv")
# create meta file with sample.ID, condition, from meta_tall.csv
if(meta_file_dm1 != ""){
...
DM1Data_df11 = read.csv(file = "/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/DM1/DM1Data_df11.csv")
...
DM1Data_df22 = read.csv(file = "/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/DM1/DM1Data_df22.csv")
...
```{r include=FALSE}
## import data
if(!file.exists("/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/IPFData_list.RData")){
  ...
  save(IPFData_list, file = "/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/IPFData_list.RData")
} else load("/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/IPFData_list.RData")
