...
read_data <- function(main_dir = "Li"){
...
Li <- read_data(main_dir = "Li")

### rbind all evals_AUC_ROC_tot from each dataset evaluated
evals_AUC_ROC_tot <- data.frame(rbind(Li))
saveRDS(evals_AUC_ROC_tot,file = "./data/evals_AUC_ROC_tot.RDS")

evals_AUC_ROC_tot <- readRDS(file = "/blackhole/alessia/circzi/checkCircRNAnormalizationdistribution/data/Li/evals_ROC_summary_dcc_df.RDS")
