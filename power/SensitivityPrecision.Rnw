...
png("/blackhole/alessia/CircModel/power/Figure/DEcalls_evaluation_IPF.png", res = 200, units = "cm", width = 25, height = 15)
...
png("/blackhole/alessia/CircModel/power/Figure/DEcalls_verification_IPF.png", res = 200, units = "cm", width = 25, height = 15)
p + geom_boxplot(outlier.colour=rgb(0,0,0,0)) + theme_bw() +
    geom_point(position = position_jitter(w = 0.1, h = 0), color="grey50", size=1) +
    # facet_grid(.~detection.method) +
    scale_color_manual(values = cols, guide="none") +
...
png("/blackhole/alessia/CircModel/power/Figure/Power_sensitivity_IPF.png", res = 200, units = "cm", width = 25, height = 15)
...
png("/blackhole/alessia/CircModel/power/Figure/Power_precision_IPF.png", res = 200, units = "cm", width = 25, height = 15)
