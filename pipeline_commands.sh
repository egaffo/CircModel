...
## collect and plot the performance evaluations
Rscript -e "rmarkdown::render('evaluations.Rmd', params = list(output_dir = 'MS_evaluations', simulated_datasets_qs = 'MS_prep_ds/datasetList.qs', sumBench_perf_metrics_qs = 'MS_performance/sumBench_perf_metrics.qs', sice = TRUE), output_file = 'evaluations_MS.html')"
## compute quality statistics on the simulated data sets after the pre-processing
